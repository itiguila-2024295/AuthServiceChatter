using AuthServiceChatter.Application.DTOs;
using AuthServiceChatter.Application.Interfaces;
using AuthServiceChatter.Application.Exceptions;
using AuthServiceChatter.Application.Extensions;
using AuthServiceChatter.Application.Validators;
using AuthServiceChatter.Domain.Constants;
using AuthServiceChatter.Domain.Entities;
using AuthServiceChatter.Domain.Interfaces;
using AuthServiceChatter.Domain.Enums;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using AuthServiceChatter.Application.DTOs.Email;

namespace AuthServiceChatter.Application.Services;
